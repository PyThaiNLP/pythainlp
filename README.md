...
- The latest stable release is [2.0.8](https://github.com/PyThaiNLP/pythainlp/tree/master)
...
- รุ่นเสถียรล่าสุดคือรุ่น [2.0.8](https://github.com/PyThaiNLP/pythainlp/tree/master)
