...
| `PYTHAINLP_ALLOW_UNSAFE_PICKLE` | ตั้งเป็น `1` เพื่อให้อ่านแฟ้ม pickle ได้ การอ่านแฟ้มชนิดนี้ถูกตั้งปิดเป็นค่าปริยาย เนื่องจากการอ่านแฟ้ม pickle อาจไปเรียกคำสั่งไม่พึงประสงค์ได้ เปิดใช้เมื่อคุณเชื่อถือแหล่งข้อมูลของคุณ | ปัจจุบัน |
