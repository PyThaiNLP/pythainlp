...
.. autoclass:: pythainlp.transliterate.fastthaig2p.FastThaiG2P
   :members:

   The `FastThaiG2P` class provides lightning-fast Thai Grapheme-to-Phoneme conversion using a 62k IPA dictionary, text normalization, and rule-based fallback.

.. autofunction:: pythainlp.transliterate.fastthaig2p.transliterate
   :noindex:

.. autofunction:: pythainlp.transliterate.fastthaig2p.normalize
   :noindex:
