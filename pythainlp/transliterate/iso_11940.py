...
_punctuation_and_digits = {
    ...
    # In this simple implementation, we decided to always treat ฯ as
    # paiyan noi.
    # We commented out angkhan diao line to remove it from the dictionary
    # and avoid having duplicate keys.
    "ๆ": "«",
    "ฯ": "ǂ",  # paiyan noi: U+01C2 ǂ Alveolar Click;
    # ICU uses ‡ (double dagger)
    "๏": "§",
    # "ฯ": "ǀ",  # angkhan diao: U+01C0 ǀ Dental Click;
    # ICU uses | (vertical bar)
    "๚": "ǁ",  # angkhan khu: U+01C1 ǁ Lateral Click;
    # ICU uses || (two vertical bars)
    "๛": "»",
    "๐": "0",
    "๑": "1",
    "๒": "2",
