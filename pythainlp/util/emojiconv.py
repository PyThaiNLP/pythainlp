...
def emoji_to_thai(text: str, delimiters=(_delimiter, _delimiter)) -> str:
    ...
    :param str text_Text with Emoji
    :return_Text with Emoji being converted to thai meaning
    :rtype_str
    ...
    :Example:
     ::
        ...
        # output: จะมานั่งรถเมล์เหมือนผมก็ได้นะครับ ใกล้ชิดประชาชนดี :หน้ายิ้มยิงฟัน:
    ...
    return emoji_regex.sub(lambda match : delimiters[0]+_emoji_th[match.group(0)]+delimiters[1], text)
