...
class TestUtilPackage(unittest.TestCase):
    ...
    def test_emoji_to_thai(self):
        self.assertEqual(emoji_to_thai("จะมานั่งรถเมล์เหมือนผมก็ได้นะครับ ใกล้ชิดประชาชนดี 😀"), "จะมานั่งรถเมล์เหมือนผมก็ได้นะครับ ใกล้ชิดประชาชนดี :หน้ายิ้มยิงฟัน:")
        self.assertEqual(emoji_to_thai("หิวข้าวอยากกินอาหารญี่ปุ่น 🍣"), "หิวข้าวอยากกินอาหารญี่ปุ่น :ซูชิ:")
        self.assertEqual(emoji_to_thai("🇹🇭 นี่คิือธงประเทศไทย"), ":ธง_ไทย: นี่คิือธงประเทศไทย")
